  ...
  <div className="bg-white rounded-full px-3 py-1 flex items-center">
    ...
    >
      ...
      <main className="flex flex-col items-center px-4 py-16">
        ...
        <div className="bg-green-900 text-white rounded-2xl shadow-lg p-8 w-full max-w-md">
          <div className="mb-4">
          ...
          <div className="flex justify-between">
            <button className="bg-green-400 hover:bg-green-500 text-black font-semibold px-6 py-2 rounded">
              Login
            </button>
            <button className="bg-green-400 hover:bg-green-500 text-black font-semibold px-6 py-2 rounded">
              Signup
